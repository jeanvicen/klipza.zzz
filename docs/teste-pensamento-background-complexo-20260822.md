...
A solicitação foi aceita pela interface com o Pensamento profundo ativo e a energia foi debitada de forma idempotente. A primeira tentativa e a segunda tentativa autorizada retornaram HTTP 429 por limite temporário de tokens por minuto do provedor de texto. Portanto, nenhuma das duas chegou à etapa de observar a resposta profunda nem de promover a resposta ao segundo plano.
...
Como o provedor permaneceu sob limite temporário nas duas tentativas, não foi feita uma terceira tentativa. O saldo de cada tentativa falha foi protegido pelo estorno idempotente. O fluxo de segundo plano permanece condicionado à página ficar oculta ou ao usuário sair; com a página visível, a resposta segue no fluxo normal. Ainda é necessário uma tentativa concluída para observar visualmente a promoção real ao segundo plano.
